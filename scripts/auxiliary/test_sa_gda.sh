...
# Get OAuth access token for the Service Account
SERVICE_ACCOUNT="search-backend-sa@${PROJECT_ID}.iam.gserviceaccount.com"
echo "🔍 Impersonating Service Account: ${SERVICE_ACCOUNT}..."
...
read -r -d '' JSON_PAYLOAD << EOF
{
  ...
  "prompt": "What are the top 3 most expensive properties listed in Zurich?",
  "context": {
