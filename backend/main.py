...
async def log_search_history(prompt: str, explanation: str):
    """
    Logs user search history to the database.
    ...
    try:
        ...
        logger.info("User prompt history saved (Search - Background).")
